...
from ultralytics.utils.distillation_loss import Distillation_loss
...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        if overrides.get("Distillation", None) and overrides.get("prune", False):
            raise ValueError("Cannot enable both pruning and distillation simultaneously. Please choose only one.")
    ...
    def _setup_train(self, world_size):
        ...
        if self.prune and self.pruner is None:
    ...
    def _do_train(self, world_size=1):
        ...
        while True:
            ...
            if self.sparse_training and self.pruner is not None:
